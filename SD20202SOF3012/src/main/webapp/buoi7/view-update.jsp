...
<body>
    ...
    <form action="/buoi7/update" method="post">
        ...
        Con hang: Con hang <input type="radio" name="conHang" value="true" ${sach.conHang == "true" ? "checked" : ""}>
        Het hang <input type="radio" name="conHang" value="false" ${!sach.conHang == "true" ? "checked" : ""}> <br>
        The loai:
        <select name="theLoai">
